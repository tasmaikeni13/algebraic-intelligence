...
| [**`phase6.md`**](phase6.md) | **Language-Model Viability & Head-to-Head Comparative Gate** | Head-to-head publication comparison at 125M and 350M scales: Algebraic Transformer vs. Standard Causal Transformer on FineWeb-Edu. |
