#!/usr/bin/env python3
"""Execute and retain the Phase 4 scientific gates; failures remain failures."""
import os
...
from scripts.phase4_experiments import (
    audit,
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'results/phase4')
    ...
    # Inherited Phase 1, 2, and 3 validation
