module @jit_oace_both attributes {mhlo.num_partitions = 16 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @oace_loss(%arg0: tensor<256x1024xbf16>, %arg1: tensor<256xi32>) -> (tensor<256xbf16>, tensor<256x1024xf32>, tensor<256x1024xf32>, tensor<256x1024xf32>) {
    ...
    return %26, %7, %9, %11 : tensor<256xbf16>, tensor<256x1024xf32>, tensor<256x1024xf32>, tensor<256x1024xf32>
  }
  func.func private @oace_loss_0(%arg0: tensor<256x1024xf32>, %arg1: tensor<256x1024xf32>, %arg2: tensor<256x1024xf32>, %arg3: tensor<256xbf16>) -> tensor<256x1024xbf16> {
    ...
    %5 = stablehlo.multiply %arg0, %4 : tensor<256x1024xf32>
    %cst_0 = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %6 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<256x1024xf32>
    %7 = stablehlo.subtract %6, %5 : tensor<256x1024xf32>
    %8 = stablehlo.multiply %3, %7 : tensor<256x1024xf32>
    %9 = stablehlo.broadcast_in_dim %1, dims = [0, 1] : (tensor<256x1xf32>) -> tensor<256x1024xf32>
    %10 = stablehlo.multiply %8, %9 : tensor<256x1024xf32>
    %11 = stablehlo.convert %10 : (tensor<256x1024xf32>) -> tensor<256x1024xbf16>
