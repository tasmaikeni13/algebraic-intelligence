module @jit_both attributes {mhlo.num_partitions = 16 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<131072x128xbf16> {mhlo.sharding = "{devices=[16,1]<=[16]}"}, %arg1: tensor<131072x128xbf16> {mhlo.sharding = "{devices=[16,1]<=[16]}"}) -> (tensor<131072x128xbf16> {jax.result_info = "result[0]"}, tensor<131072x128xbf16> {jax.result_info = "result[1]"}) {
    %0:5 = call @algebraic_softmax(%arg0) : (tensor<131072x128xbf16>) -> (tensor<131072x128xbf16>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>)
    %1 = call @algebraic_softmax_1(%0#1, %0#2, %0#3, %0#4, %arg1) : (tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>, tensor<131072x128xbf16>) -> tensor<131072x128xbf16>
    return %0#0, %1 : tensor<131072x128xbf16>, tensor<131072x128xbf16>
  }
  func.func private @algebraic_softmax(%arg0: tensor<131072x128xbf16>) -> (tensor<131072x128xbf16>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>) {
    ...
    return %39, %10, %8, %38, %14 : tensor<131072x128xbf16>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>
  }
  ...
  func.func private @algebraic_softmax_1(%arg0: tensor<131072x128xf32>, %arg1: tensor<131072x1xf32>, %arg2: tensor<131072x128xf32>, %arg3: tensor<131072x128xf32>, %arg4: tensor<131072x128xbf16>) -> tensor<131072x128xbf16> {
    %0 = stablehlo.convert %arg4 : (tensor<131072x128xbf16>) -> tensor<131072x128xf32>
    %1 = stablehlo.multiply %arg2, %0 : tensor<131072x128xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %2 = stablehlo.reduce(%1 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<131072x128xf32>, tensor<f32>) -> tensor<131072xf32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [0] : (tensor<131072xf32>) -> tensor<131072x1xf32>
    %cst_0 = stablehlo.constant dense<8.000000e+00> : tensor<f32>
    %4 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<131072x128xf32>
    %5 = stablehlo.multiply %4, %arg3 : tensor<131072x128xf32>
    %6 = stablehlo.multiply %5, %arg2 : tensor<131072x128xf32>
    %7 = stablehlo.broadcast_in_dim %3, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %8 = stablehlo.subtract %0, %7 : tensor<131072x128xf32>
    %9 = stablehlo.multiply %6, %8 : tensor<131072x128xf32>
    %10 = stablehlo.multiply %9, %arg0 : tensor<131072x128xf32>
    %cst_1 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %11 = stablehlo.reduce(%10 init: %cst_1) applies stablehlo.add across dimensions = [1] : (tensor<131072x128xf32>, tensor<f32>) -> tensor<131072xf32>
    %12 = stablehlo.broadcast_in_dim %11, dims = [0] : (tensor<131072xf32>) -> tensor<131072x1xf32>
    %cst_2 = stablehlo.constant dense<7.812500e-03> : tensor<f32>
    %13 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<131072x1xf32>
    %14 = stablehlo.multiply %12, %13 : tensor<131072x1xf32>
    %15 = stablehlo.broadcast_in_dim %14, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %16 = stablehlo.multiply %15, %arg0 : tensor<131072x128xf32>
    %17 = stablehlo.subtract %9, %16 : tensor<131072x128xf32>
    %18 = stablehlo.broadcast_in_dim %arg1, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %19 = stablehlo.multiply %18, %17 : tensor<131072x128xf32>
    %20 = stablehlo.convert %19 : (tensor<131072x128xf32>) -> tensor<131072x128xbf16>
    return %20 : tensor<131072x128xbf16>
  }
}
