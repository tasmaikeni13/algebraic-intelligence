module @jit_both attributes {mhlo.num_partitions = 16 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<131072x128xf32> {mhlo.sharding = "{devices=[16,1]<=[16]}"}, %arg1: tensor<131072x128xf32> {mhlo.sharding = "{devices=[16,1]<=[16]}"}) -> (tensor<131072x128xf32> {jax.result_info = "result[0]"}, tensor<131072x128xf32> {jax.result_info = "result[1]"}) {
    %0:4 = call @algebraic_softmax(%arg0) : (tensor<131072x128xf32>) -> (tensor<131072x128xf32>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>)
    %1 = call @algebraic_softmax_1(%0#1, %0#2, %0#0, %0#3, %arg1) : (tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>, tensor<131072x128xf32>) -> tensor<131072x128xf32>
    return %0#0, %1 : tensor<131072x128xf32>, tensor<131072x128xf32>
  }
  func.func private @algebraic_softmax(%arg0: tensor<131072x128xf32>) -> (tensor<131072x128xf32>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>) {
    ...
    return %37, %9, %7, %13 : tensor<131072x128xf32>, tensor<131072x128xf32>, tensor<131072x1xf32>, tensor<131072x128xf32>
  }
  ...
  func.func private @algebraic_softmax_1(%arg0: tensor<131072x128xf32>, %arg1: tensor<131072x1xf32>, %arg2: tensor<131072x128xf32>, %arg3: tensor<131072x128xf32>, %arg4: tensor<131072x128xf32>) -> tensor<131072x128xf32> {
    %0 = stablehlo.multiply %arg2, %arg4 : tensor<131072x128xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %1 = stablehlo.reduce(%0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<131072x128xf32>, tensor<f32>) -> tensor<131072xf32>
    %2 = stablehlo.broadcast_in_dim %1, dims = [0] : (tensor<131072xf32>) -> tensor<131072x1xf32>
    %cst_0 = stablehlo.constant dense<8.000000e+00> : tensor<f32>
    %3 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<131072x128xf32>
    %4 = stablehlo.multiply %3, %arg3 : tensor<131072x128xf32>
    %5 = stablehlo.multiply %4, %arg2 : tensor<131072x128xf32>
    %6 = stablehlo.broadcast_in_dim %2, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %7 = stablehlo.subtract %arg4, %6 : tensor<131072x128xf32>
    %8 = stablehlo.multiply %5, %7 : tensor<131072x128xf32>
    %9 = stablehlo.multiply %8, %arg0 : tensor<131072x128xf32>
    %cst_1 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %10 = stablehlo.reduce(%9 init: %cst_1) applies stablehlo.add across dimensions = [1] : (tensor<131072x128xf32>, tensor<f32>) -> tensor<131072xf32>
    %11 = stablehlo.broadcast_in_dim %10, dims = [0] : (tensor<131072xf32>) -> tensor<131072x1xf32>
    %cst_2 = stablehlo.constant dense<7.812500e-03> : tensor<f32>
    %12 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<131072x1xf32>
    %13 = stablehlo.multiply %11, %12 : tensor<131072x1xf32>
    %14 = stablehlo.broadcast_in_dim %13, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %15 = stablehlo.multiply %14, %arg0 : tensor<131072x128xf32>
    %16 = stablehlo.subtract %8, %15 : tensor<131072x128xf32>
    %17 = stablehlo.broadcast_in_dim %arg1, dims = [0, 1] : (tensor<131072x1xf32>) -> tensor<131072x128xf32>
    %18 = stablehlo.multiply %17, %16 : tensor<131072x128xf32>
    return %18 : tensor<131072x128xf32>
  }
}
